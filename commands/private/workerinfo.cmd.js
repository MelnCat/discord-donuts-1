...
module.exports =
	new DDCommand()
		...
		.setFunction(async(message, args, client) => {
			...
			const workerraw = await data.findOrCreate({ where: { id: user.id }, defaults: { id: user.id, cooks: 0, delivers: 0, lastCook: 0, lastDeliver: 0, username: user.tag, lastCookIds: "[]", lastDeliverIds: "[]" } });

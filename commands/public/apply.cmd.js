...
module.exports =
	new DDCommand()
		...
		.setFunction(async(message, args, client) => {
			...
			message.author.send(`Thank you for applying. Your application code is \`${message.author.id.substr(5, 10)}\`. Thank you!`);
			await Applications.create({ id: message.author.id, application: JSON.stringify(responses), code: message.author.id.substr(5, 10) });
